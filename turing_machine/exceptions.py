...
class RejectStateError(AutomatonError):
    """A reject state fails to meet some required condition."""

    pass

class LeftEndError(AutomatonError):
    """LeftEnd is write ."""

    pass

class Badcounttapes(AutomatonError):
    """Bad count tapes  ."""
...
class InvalidDirectionError(AutomatonError):
